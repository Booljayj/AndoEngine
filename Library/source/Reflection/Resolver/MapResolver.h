...
#define L_MAP_TYPE_RESOLVER( __TEMPLATE__, __DESCRIPTION__, __FLAGS__ )\
...
namespace Reflection {
	...
	L_MAP_TYPE_RESOLVER( std::map, "ordered map", FTypeFlags::None );
	L_MAP_TYPE_RESOLVER( std::unordered_map, "unordered map", FTypeFlags::None );
}
