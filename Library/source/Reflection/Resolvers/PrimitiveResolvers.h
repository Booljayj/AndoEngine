...
namespace Reflection {
	...
	struct TypeResolver<std::basic_string<CharType>> {
	...
	template<typename CharType>
	TPrimitiveTypeInfo<std::basic_string<CharType>> const TypeResolver<std::basic_string<CharType>>::typeInfo = TPrimitiveTypeInfo<std::basic_string<CharType>>{}
